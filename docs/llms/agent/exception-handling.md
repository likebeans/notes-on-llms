...
> 来源：[Agentic Design Patterns - Exception Handling and Recovery](https://github.com/ginobefun/agentic-design-patterns-cn)

### 为什么需要异常处理？

::: tip 定义
**异常处理与恢复**模式使AI智能体具备管理突发状况、错误和故障的能力，确保即使在面临挑战时也能持续运行。
:::
...
- [反思模式](/llms/agent/reflection) - 可与异常处理结合使用
- [规划模式](/llms/agent/planning) - 异常时可触发重规划
- [工具调用](/llms/agent/tool-calling) - 工具调用是异常高发点
